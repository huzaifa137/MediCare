...
<head>
    ...
    <title>{{Helper::app_name()}} Password Reset</title>
    <style>
        body {
        ...
        .header {
            ...
            /* Adjust margin to extend to container edges */
            color: #ffffff;
        ...
        .link-text {
            ...
            color: #007bff;
            /* A standard blue for links, or adjust to complement brand */
            font-size: 14px;
            margin-top: 15px;
            display: block;
        }
...
<body>
    <div style="background-color:#2d9eef; padding: 30px 0;">
        <div class="container">
            <div class="header">
                <h1>{{Helper::app_name()}} (Reset Password )</h1>
            </div>
            <div class="content">
                ...
                <p style="margin-top: 30px;">If the button above doesn't work, you can also copy and paste the following
                    link into your web browser:</p>
                <span class="link-text">{{ $resetUrl }}</span>
            </div>
            <div class="footer">
                <p>&copy; {{ date('Y') }} {{ Helper::app_name() }}. All rights reserved.</p>
