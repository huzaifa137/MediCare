      ...
      <form id="formDoctorRegistration" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-4 mt-4">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="fullName" name="fullName" placeholder="Dr. John Doe">
        ...
        <div class="row g-4 mt-4">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="issuingBody" name="issuingBody">
            <span class="text-danger d-block mt-1" id="issuingBody-error"></span>
          </div>
          <!-- Years of Experience -->
          <div class="col-md-6">
            <label for="experience" class="form-label">Years of Experience</label>
            <input type="number" class="form-control" id="experience" name="experience" placeholder="e.g. 5">
        ...
        <div class="row g-4 mt-4">
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" id="consultationMethod" name="consultationMethod">
      ...
      $('#formDoctorRegistration').on('submit', function (e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            var form = $('#formDoctorRegistration');
