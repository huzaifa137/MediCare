                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-around py-3 my-4">
                                            <div class="gap-3 d-flex align-items-start mt-3 me-4">
                                                <span class="badge bg-label-primary rounded p-2"><i
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <sup
                                                    class="h5 pricing-currency text-primary mt-3 mt-sm-4 me-1 mb-0">$</sup>
                                                <h1 class="display-3 text-primary fw-normal mb-0">99</h1>
                                                <sub class="fs-6 pricing-duration mt-auto mb-4">/month</sub>
                                            </div>
                                        </div>
                                        <ul class="g-2 ps-3 mb-3">
                                        ...
                                        <div class="d-grid w-100 pt-2 mt-3">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="editUserForm" class="row g-3" onsubmit="return false">
                                            ...
                                            <div class="col-12 text-center mt-4">
                                                <button type="submit"
                                                    class="btn btn-primary me-1 me-sm-3">Submit</button>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                                            <div class="d-flex justify-content-center mt-2 me-2">
                                                <sup
                                                    class="h5 pricing-currency text-primary fw-normal pt-2 mt-4 me-1 mb-0">$</sup>
                                                <h1 class="display-1 text-primary fw-normal mb-0">99</h1>
